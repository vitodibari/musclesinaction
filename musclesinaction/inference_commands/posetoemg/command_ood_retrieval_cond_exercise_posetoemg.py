...
script_path = "musclesinaction/inference_scripts/retrieval_ood_cnn_exercises.py"
...
for i, ex in enumerate(exercises):
    ...
    # Handle the 'SOODeLunges' typo if it was intentional, but here we standardize
    name_ex = "SideLunges" if ex == "SideLunges" else ex
    
    variations.append({
        "session_name": session_name,
        "cuda": i % 8,
        "args": {
            "name": f"generalization_test_cond_{name_ex}_clean_baseline_perex",
