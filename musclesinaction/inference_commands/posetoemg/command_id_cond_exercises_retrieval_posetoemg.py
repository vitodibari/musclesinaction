...
script_path = "musclesinaction/inference_scripts/retrieval_id_exercises_posetoemg.py"
...
for i, ex in enumerate(exercises):
    ...
    variations.append({
        ...
        "args": {
            ...
            "data_path_val": f"musclesinaction/ablation/generalization_ID_cond_exercises_nn/val{ex}.txt",
        }
    })
