...
for i, ex in enumerate(exercises):
    # Some special cases for session names if needed, but keeping it consistent
    ...
    variations.append({
        ...
        "args": {
            ...
            "resume": f"pretrained-checkpoints/generalization_new_cond_clean_posetoemg/model_100.pth",
